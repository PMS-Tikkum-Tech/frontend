...
const EXACT_ID_TO_EN: Record<string, string> = {
  ...
  "Pemantauan tagihan, pengingat batas pembayaran, dan rekap pembayaran berkala.":
    "Monitor bills, payment deadline reminders, and periodic payment summaries.",
  ...
  "Batas Pembayaran Terdekat": "Nearest Payment Deadline",
  ...
  "Pembayaran melewati batas waktu": "Payment passed the deadline",
  ...
  "Terlambat": "Overdue",
  "Batas Pembayaran": "Payment Deadline",
  "Melewati Batas Pembayaran": "Past Payment Deadline",
  "Lewat Batas Bayar": "Past Deadline",
...
const FRAGMENT_ID_TO_EN: Array<[string, string]> = [
  ...
  ["Tagihan sudah dibatalkan otomatis karena melewati batas pembayaran.", "The bill has been automatically cancelled because it passed the payment deadline."],
  ["Dibatalkan otomatis karena melewati batas pembayaran.", "Automatically cancelled because it passed the payment deadline."],
  ["Pembayaran dibatalkan otomatis karena melewati batas pembayaran.", "Payment was automatically cancelled because it passed the payment deadline."],
